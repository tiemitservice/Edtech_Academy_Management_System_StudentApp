...
class AddressService {
  ...
  String getProvinceName(String provinceCode) {
    final province = _provinces.firstWhere(
      ...
      orElse: () => {
        'properties': {'NAME_ENG1': 'N/A'}
      },
    );
    return province['properties']['NAME_ENG1'];
  }
  ...
  String getDistrictName(String districtCode) {
    final district = _districts.firstWhere(
      ...
      orElse: () => {
        'properties': {'NAME_ENG2': 'N/A'}
      },
    );
    return district['properties']['NAME_ENG2'];
  }
  ...
  String getCommuneName(String communeCode) {
    final commune = _communes.firstWhere(
      ...
      orElse: () => {
        'properties': {'NAME_ENG3': 'N/A'}
      },
    );
    return commune['properties']['NAME_ENG3'];
  }
  ...
  String getVillageName(String villageCode) {
    final village = _villages.firstWhere(
      ...
      orElse: () => {
        'properties': {'NAME_ENG': 'N/A'}
      },
    );
    return village['properties']['NAME_ENG'];
  }
